...
class ProviderCertification(models.Model):
    ...
    # ═══════════════════════════════════════════════════════════════════
    # NEW: Service types this certification qualifies for
    # ═══════════════════════════════════════════════════════════════════
    certified_service_types = models.JSONField(
        default=list,
        blank=True,
        help_text="List of service types this certification qualifies for (e.g., ['massage', 'facial'])"
    )
...
class ServiceRequest(models.Model):
    ...
    def refund_referral_credit_if_applicable(self):
        ...
        # Check if credit already refunded (add new field for tracking)
        if getattr(self, 'referral_credit_refunded', False):
